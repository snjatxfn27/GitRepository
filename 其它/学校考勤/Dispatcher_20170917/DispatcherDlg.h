...
public:
	...
	*/
	...
	int ProcessOneSnapData(int iSnapshotid, CString strFacePhotoName, CString strFullPhotoName);
	...
	BOOL ConnectDB();
	BOOL InsertAlarmToDB(CString strSnapshotId, CString strIDCard, CString strSim);
	BOOL UpdateProcessStatusToDB(int iSnapshotid, int iStatus);
	BOOL DeleteSnaphotidToDB(int iSnapshotid);
		// 对话框数据
