...
// WinSnapshotServer.h : PROJECT_NAME 应用程序的主头文件
//
...
// 有关此类的实现，请参阅 WinSnapshotServer.cpp
//

class CWinSnapshotServerApp : public CWinApp
{
public:
	CWinSnapshotServerApp();
	CString m_strDBIP;
...
extern CWinSnapshotServerApp theApp;