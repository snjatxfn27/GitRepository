...
extern "C" __declspec(dllexport) int  FASFeatureDetectforImageFileForNet(const char * pIP, const char * pSession, const char * pFilePathIn, const char * pFilePathOut, char* chJson, int jsonlen);
/****************************************
特征比对头文件
*****************************************/
//特征比对特征
