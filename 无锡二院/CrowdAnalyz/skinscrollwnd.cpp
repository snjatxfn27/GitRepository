...
BOOL CSkinScrollWnd::SkinWindow(CWnd *pWnd,HBITMAP hBmpScroll)
{
	...
	this->CreateEx(dwFrmStyleEx,AfxRegisterWndClass(NULL),L"SkinScrollBarFrame",dwFrmStyle,rcFrm,pParent,uID);

	m_wndLimit.Create(NULL,L"LIMIT",WS_CHILD|WS_VISIBLE,CRect(0,0,0,0),this,200);
...
void CSkinScrollWnd::OnTimer(UINT_PTR nIDEvent)
{
	CWnd *pWnd=m_wndLimit.GetWindow(GW_CHILD);
	SCROLLINFO si1={0};
